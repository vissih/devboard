    ...
    <header className="flex justify-between items-center h-16 px-6 bg-background">
      ...
      <nav>
        <ul className="flex space-x-4">
          ...
          <li>
            <Link href="https://x.com/vissih" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-all border-b border-current border-dashed opacity-70 hover:opacity-100 duration-300 ease-in-out pb-[2px]">
              Contact
            </Link>
          </li>
        </ul>
